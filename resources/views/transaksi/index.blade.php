                    ...
                    <table class="table table-striped" id="table">
                      ...
                      @foreach($datas as $data)
                        <tr>
                          ...
                          @endif
                          <form action="{{ route('transaksi.show', $data->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('get') }}
                            <button class="dropdown-item" onclick="return confirm('Anda yakin ingin melihat detail data ini?')"> Show
                            </button>
                          </form>
